                        ...
                        bout.red_series.status !==
                          ...
                          <Chip
                            ...
                            label={
                              bout.red_series.status ===
                              "graduated"
                                ? "FIRST 5 FIGHTS SERIES ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â GRADUATED"
                                : `FIRST 5 FIGHTS SERIES ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â FIGHT ${bout.red_series.next_fight_number} OF ${bout.red_series.target_fights}`
                            }
                          />
                        )}
                        ...
                        bout.blue_series.status !==
                          ...
                          <Chip
                            ...
                            label={
                              ...
                              "graduated"
                                ? "FIRST 5 FIGHTS SERIES ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â GRADUATED"
                                : `FIRST 5 FIGHTS SERIES ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â FIGHT ${bout.blue_series.next_fight_number} OF ${bout.blue_series.target_fights}`
                            }
                          />
                        )}
                ...
                <CardContent>
                        ...
                        {bout.red_series &&
                          bout.red_series.status !==
                            ...
                            <Chip
                              ...
                              color="primary"
                              label={
                                `RED: ${bout.red?.legal_name || "Fighter"} ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â First 5 Fight ${bout.red_series.next_fight_number} of ${bout.red_series.target_fights}`
                              }
                            />
                          )}
                        ...
                        {bout.blue_series &&
                          bout.blue_series.status !==
                            ...
                            <Chip
                              ...
                              color="primary"
                              label={
                                `BLUE: ${bout.blue?.legal_name || "Fighter"} ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â First 5 Fight ${bout.blue_series.next_fight_number} of ${bout.blue_series.target_fights}`
                              }
                            />
                          )}
                      </Stack>
                  ...
                  <Grid container spacing={3}>
                    <Grid item xs={12} md={6}>
                      ...
                      <Typography>
                        BoxRec #
                        {bout.red?.boxrec_id || "ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â"}
                      </Typography>

                      <Typography>
                        Phone:{" "}
                        {bout.red?.phone || "ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â"}
                      </Typography>

                      <Typography>
                        Email:{" "}
                        {bout.red?.email || "ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â"}
                      </Typography>
                    ...
                    <Grid item xs={12} md={6}>
                      ...
                      <Typography>
                        Phone:{" "}
                        {bout.blue?.phone || "ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â"}
                      </Typography>

                      <Typography>
                        Email:{" "}
                        {bout.blue?.email || "ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â"}
                      </Typography>
